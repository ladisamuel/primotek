            ...
            <div>
                <div className='px-[25px] md:px-[50px] xs:px-5 lg:px-[100px] pt-20 bg[red] m-auto'>
                    <div className='grid  grid-cols-1 lg:grid-cols-3 items-center gap-y-10'>
                        ...
                        <p className='float-end text-[blue] text-center'>We define your competition and target audience. Discover what is working in your online industry, then design your website accordingly.</p>
                    </div>
                </div>
                <div className='px-[25px] md:px-[50px] xs:px-5 lg:px-[100px] pt-20 bg[red] m-auto'>
                    <div className='grid  grid-cols-1 lg:grid-cols-3 items-center  gap-y-10 '>
                        <p className='order-last lg:order-first float-end text-[#ff6600] text-center'>We define your competition and target audience. Discover what is working in your online industry, then design your website accordingly.</p>
                        ...
                        <div className='order-first lg:order-last flex items-center justify-start '>
                ...
                <div className='px-[25px] md:px-[50px] xs:px-5 lg:px-[100px] pt-20 bg[red] m-auto'>
                    <div className='grid grid-cols-1 lg:grid-cols-3 items-center gap-y-10'>
                        ...
                        <p className='float-end text-lime-500 text-center'>We define your competition and target audience. Discover what is working in your online industry, then design your website accordingly.</p>
                    </div>
                </div>
                    ...
                    <div className="px-[25px] md:px-[50px] lg:px-[100px] my-20 grid md:grid-cols-2 lg:grid-cols-3 gap-4 ">
                        ...
                        <div className=''>
                            <div className="team_cover ">
                                <img src={Teams[0].img} alt="" className='w-full '/>
                                <div className='team_content '>
                                    <div className='flex flex-col text-center'>

                                        <p className='text-white text-lg'>{Teams[0].name} </p>
                                        <p className=' text-white'>{Teams[0].position} </p>
                        ...
                        <div className=''>
                            <div className="team_cover ">
                                <img src={Teams[1].img} alt="" className='w-full '/>
                                <div className='team_content '>
                                    <div className='flex flex-col text-center'>

                                        <p className='text-white text-lg'>{Teams[1].name} </p>
                                        <p className=' text-white'>{Teams[1].position} </p>
                                        <i className="pi pi-linkedin bg-whit text-white text-lg hover:cursor-pointer"></i>
                                    </div>
                        ...
                        <div className=''>
                            <div className="team_cover ">
                                <img src={Teams[2].img} alt="" className='w-full '/>
                                <div className='team_content '>
                                    <div className='flex flex-col text-center'>

                                        <p className='text-white text-lg'>{Teams[2].name} </p>
                                        <p className=' text-white'>{Teams[2].position} </p>
                                        <i className="pi pi-linkedin bg-whit text-white text-lg hover:cursor-pointer"></i>
                                    </div>
                        ...
                        <div className=''>
                            <div className="team_cover ">
                                <img src={Teams[3].img} alt="" className='w-full '/>
                                <div className='team_content '>
                                    <div className='flex flex-col text-center'>

                                        <p className='text-white text-lg'>{Teams[3].name} </p>
                                        <p className=' text-white'>{Teams[3].position} </p>
                                        <i className="pi pi-linkedin bg-whit text-white text-lg hover:cursor-pointer"></i>
                                    </div>
                        ...
                        <div className=''>
                            <div className="team_cover ">
                                <img src={Teams[4].img} alt="" className='w-full '/>
                                <div className='team_content '>
                                    <div className='flex flex-col text-center'>

                                        <p className='text-white text-lg'>{Teams[4].name} </p>
                                        <p className=' text-white'>{Teams[4].position} </p>
                                        <i className="pi pi-linkedin bg-whit text-white text-lg hover:cursor-pointer"></i>
                                    </div>
                        ...
                        <div className=''>
                            <div className="team_cover ">
                                <img src={Teams[5].img} alt="" className='w-full '/>
                                <div className='team_content '>
                                    <div className='flex flex-col text-center'>

                                        <p className='text-white text-lg'>{Teams[5].name} </p>
                                        <p className=' text-white'>{Teams[5].position} </p>
                                        <i className="pi pi-linkedin bg-whit text-white text-lg hover:cursor-pointer"></i>
                                    </div>
