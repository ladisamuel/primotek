            ...
            <div className="bg-black">
              ...
              <div className="px-[20px] py-[10px]">
                ...
                <div className="flex items-center justify-between text-[15px] mt-[10px]">
                  <div className="text-xs flex items-center justify-start gap-2 flex-wrap ">
                    <span className="text-white bg-[#70A9FF] px-[7px] rounded-[4px]">
                      {MyTravellingData[0].rating.toFixed(1)}
                    </span>
                    <span className="text-[white]">{MyTravellingData[0].no_rating}</span>
                    <span className="text-[white]">|</span>
                    <span className="text-[white]">
                      {MyTravellingData[0].fm}{" "}
                      <span className="text-[red]">
                        {MyTravellingData[0].form_amount[0]} - {MyTravellingData[0].form_amount[1]}
                      </span>
                    </span>
                    <span className="text-[white]"> |</span>
                    <span className="text-[white]">{MyTravellingData[0].occupation}</span>
                  </div>
                </div>
                <div className="flex justify-start items-start gap-2 mt-[15px]">
                  <img src={MyTravellingData[0].profile_picture} alt="" />
                  <p className="text-[14px] text-[white] text-left w-full">
                    {MyTravellingData[0].description.substring(0, 70)}....{" "}
                ...
                <div className="flex justify-between items-center mb-[10px]">
                  {MyTravellingData[0].availability === true ? (
